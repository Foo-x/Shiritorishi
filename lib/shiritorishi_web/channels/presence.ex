defmodule ShiritorishiWeb.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule Shiritorishi.MyChannel do
        use ShiritorishiWeb, :channel
  ...
  """
  use Phoenix.Presence, otp_app: :shiritorishi,
                        pubsub_server: Shiritorishi.PubSub
end
